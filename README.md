...
**Статус:** ✅ M1 — логин-сервер (SRP6 + список реалмов). 🟡 M2 — world handshake
(RC4-шифрование заголовков, `CMSG_AUTH_SESSION` → `SMSG_AUTH_RESPONSE`), реализован,
ждёт проверки живым клиентом. Следующая веха — M3 (экран персонажей).
