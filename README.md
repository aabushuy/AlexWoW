...
**Статус:** ✅ M1 (SRP6-логин), ✅ M2 (RC4-handshake), ✅ M3 (экран персонажей),
🟡 M4 (**вход в мир: персонаж управляется — камера, бег, прыжки**) — проверено
живым клиентом 3.3.5a. Осталось по M4: чат и серверное движение. Дальше — M5
(видимость, NPC, другие игроки).
