...
**Статус:** ✅ M1–M4 — **играбельный минимум готов и проверен живым клиентом 3.3.5a**:
логин, экран персонажей, вход в мир, движение/прыжки/камера, чат (с кириллицей),
логаут, **сохранение позиции**. Дальше — M5 (видимость, NPC, другие игроки).
