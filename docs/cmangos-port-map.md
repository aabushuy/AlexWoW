...
| `src/game/Spells/UnitAuraProcHandler.cpp` | Прок-флаги, события (~5000 строк) | [`Handlers/ProcService.cs`](../src/AlexWoW.WorldServer/Handlers/ProcService.cs) + [`ProcFlag.cs`](../src/AlexWoW.WorldServer/Handlers/ProcFlag.cs) (enum 25 битов из CMaNGOS SpellMgr.h, T1 ✅) | 🟡 |
