...
| `src/game/Entities/Pet.cpp` + `PetHandler.cpp` + `AI/BaseAI/PetAI.cpp` | Хантер/локер питомцы (~5230 строк CMaNGOS) | [`World/Pet.cs`](../src/AlexWoW.WorldServer/World/Pet.cs) + [`PetRegistry.cs`](../src/AlexWoW.WorldServer/World/PetRegistry.cs) + [`Handlers/Pet/`](../src/AlexWoW.WorldServer/Handlers/Pet/) — T1✅ каркас (Pet entity + enums + registry), T5✅ persistence (character_pet, EF migration, IPetRepository, HostedService recovery). T2 PetAI, T3 actions/spells, T4 Hunter taming. | 🟡 |
