...
| `src/game/Spells/UnitAuraProcHandler.cpp` | Прок-флаги, события (~5000 строк) | [`Handlers/ProcService.cs`](../src/AlexWoW.WorldServer/Handlers/ProcService.cs) + [`ProcFlag.cs`](../src/AlexWoW.WorldServer/Handlers/ProcFlag.cs) (25 битов) + [`ProcFlagEx.cs`](../src/AlexWoW.WorldServer/Handlers/ProcFlagEx.cs) (22 бита). T1✅/T2✅/T3✅/T4✅/T5✅ — enum, procEx-фильтр, ICD, PPM, spell-family. T6: смок 4 целевых спелла. | 🟡 |
...
| `src/game/Player/Player.cpp` (ratings) | Combat ratings: hit/crit/haste/parry + MOD_RATING(189) | [`DataStores/CombatRatingConversion.cs`](../src/AlexWoW.DataStores/CombatRatingConversion.cs) + интеграции в [`PeriodicsService.cs`](../src/AlexWoW.WorldServer/Handlers/PeriodicsService.cs), [`PlayerMeleeService.cs`](../src/AlexWoW.WorldServer/Handlers/PlayerMeleeService.cs), [`SpellCastService.cs`](../src/AlexWoW.WorldServer/Handlers/SpellCastService.cs), [`SpellEffectsService.cs`](../src/AlexWoW.WorldServer/Handlers/SpellEffectsService.cs), [`CreatureCombatAI.cs`](../src/AlexWoW.WorldServer/Handlers/CreatureCombatAI.cs) — **SPELL.T1**: ауры 47/52/54/55/57/138/140/189/193/216/217 → crit/parry/melee-haste/spell-haste/GCD. UI-сводка обновится при ближайшем RefreshMeleeAsync. Hit-чанс собирается, но spell-miss/melee-miss резолверов пока нет. | 🟡 |
...
| `src/game/Guilds/Guild.cpp` + `GuildHandler.cpp` + `GuildMgr.cpp` | Гильдии (~47 опкодов, 4438 строк CMaNGOS) | [`World/Guild.cs`](../src/AlexWoW.WorldServer/World/Guild.cs) + [`GuildRegistry.cs`](../src/AlexWoW.WorldServer/World/GuildRegistry.cs) + [`Handlers/Guild/`](../src/AlexWoW.WorldServer/Handlers/Guild/) + [`Protocol/GuildPackets.cs`](../src/AlexWoW.WorldServer/Protocol/GuildPackets.cs) — T1✅ create/invite/accept/decline/leave/disband/query/info, T2-T4✅ roster/promote/demote/remove/leader/MOTD/notes, T5✅ persistence. T6 смок. | 🟡 |
| `src/game/Entities/Pet.cpp` + `PetHandler.cpp` + `AI/BaseAI/PetAI.cpp` | Хантер/локер питомцы (~5230 строк CMaNGOS) | [`World/Pet.cs`](../src/AlexWoW.WorldServer/World/Pet.cs) + [`PetRegistry.cs`](../src/AlexWoW.WorldServer/World/PetRegistry.cs) + [`Handlers/Pet/`](../src/AlexWoW.WorldServer/Handlers/Pet/) — T1✅ каркас, T2✅ PetAI scaffold, T3✅ PET_ACTION/RENAME/NAME_QUERY/SET_ACTION + SMSG_PET_MODE/NAME_INVALID, T4✅ HunterPetService (TameBeast/Happiness/level sync), T5✅ persistence. T6 смок. T2.1/T3.1 — полная интеграция с боем + spell-bar UI. | 🟡 |
