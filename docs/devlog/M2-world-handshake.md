...
**Статус:** 🟡 реализовано и развёрнуто. Ждёт финальной проверки живым клиентом.
...
- ⬜ **Финальная валидация — живой клиент 3.3.5a.** RC4 header crypt и digest должны
  совпасть байт-в-байт; покажет только `Wow.exe` (вход в мир → пустой экран персонажей).
