...
|---|---|---|---|---|
| Дар Бездны (Fel Armor) | 28176 | toggle / щит+spellpower | Toggle | ✅ эксклюзивная группа (тот же механизм, проверен на маге); стат не моделируется |
| Доспех Демона (Demon Armor) | 706 | toggle / броня | Toggle | ✅ эксклюзивная группа (тот же механизм, проверен на маге); стат не моделируется |
