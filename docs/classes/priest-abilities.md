...
| Облик Тьмы (Shadowform) | 15473 | форма 28 / MOD_DAMAGE% | Toggle (форма) | 🟡 toggle-форма (визуал 28) + **+15% Shadow-урона** (MOD_DAMAGE_PERCENT_DONE); пока только прямой урон, DoT-тики ⬜ |
