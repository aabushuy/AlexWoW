...
| MOD_DODGE_PERCENT (49) | Evasion (Разб) ✅, Quickness-расовый ⬜ | 🟡 DODGE.1 (data-driven aura 49 → +% уклонения; резолвер мили-удара добавляет бонус к базовому dodge, обновляет PLAYER_DODGE_PERCENTAGE. Evasion 5277/26669 +50% 15с — парсер подтверждён, ждёт живой проверки: `.dummy attack` → ~половина свингов «Уклонение». Quickness — пассив-расовый на ауре 154, отдельно) |
