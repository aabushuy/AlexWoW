...
| SCHOOL_ABSORB / MANA_SHIELD | PW:Shield (Жрец) ✅, Ice Barrier/Fire/Frost Ward (Маг) ✅, Mana Shield (Маг) ✅, Sacred Shield (Пал) ✅; Anti-Magic Shell (DK) ⬜ | ✅ ABS.1–ABS.2 (поглощение мили существ по школе + absorb в damage-логе; Mana Shield тратит ману). 🟡 ABS.3 Sacred Shield 53601 (рус. «Священный щит», ≠ Holy Shield 48952): прок-поглощение ~500 на получение урона, ICD 6с — упрощённо (прок-на-получение-урона целиком не моделируется; поглощаем мили-удар напрямую), ждёт проверки. Todo: персист, поглощение спелл-урона существ |
