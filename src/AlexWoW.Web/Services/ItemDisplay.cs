...
public static class ItemDisplay
{
    ...
    private static readonly Dictionary<uint, string> StatNames = new()
    {
        ...
        [15] = "к рейтингу блока",
        [16] = "к рейтингу меткости (дальн.)",
        [17] = "к рейтингу меткости (ближ.)",
        [18] = "к рейтингу меткости (закл.)",
        [19] = "к рейтингу крита (дальн.)",
        [20] = "к рейтингу крита (ближ.)",
        [21] = "к рейтингу крита (закл.)",
        [28] = "к рейтингу скорости (дальн.)",
        [29] = "к рейтингу скорости (ближ.)",
        [30] = "к рейтингу скорости (закл.)",
        [31] = "к рейтингу меткости",
        [32] = "к рейтингу крит. удара",
        [35] = "к устойчивости",
        [36] = "к рейтингу скорости",
        [37] = "к мастерству",
        [38] = "к силе атаки",
        [39] = "к силе атаки (дальн.)",
        [43] = "к восст. маны",
        [44] = "к пробиванию брони",
        [45] = "к силе заклинаний",
        [46] = "к восст. здоровья",
        [47] = "к проникающей способности заклинаний",
        [48] = "к величине блока",
    };
