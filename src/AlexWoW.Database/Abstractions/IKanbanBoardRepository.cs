...
public interface IKanbanBoardRepository
{
    ...
    /// <summary>Задачи на тестирование для персонажа: tester_guid = guid, client_check=1, статус Testing.</summary>
    Task<IReadOnlyList<KanbanTesterTask>> GetTesterTasksAsync(uint testerGuid, CancellationToken ct = default);
