...
public static class Professions
{
    ...
    {
        164 => "кузнечное дело", 165 => "кожевничество", 171 => "алхимия", 182 => "травничество",
        185 => "кулинария", 186 => "горное дело", 197 => "портняжное дело", 202 => "инженерное дело",
        333 => "наложение чар", 356 => "рыбная ловля", 393 => "снятие шкур", 755 => "ювелирное дело",
        773 => "начертание", 129 => "первая помощь", _ => "навык",
    };
