...
public static class DisplayData
{
    ...
    private static readonly Dictionary<(byte Race, byte Form), uint> FormModels = new()
    {
        ...
        // §1 Метаморфоза ЧК (форма 22) — единая демон-модель 25277 для всех рас (SpellShapeshiftForm.dbc:
        // modelID_A=25277, modelID_H=0). ЧК-расы: Human/Orc/Dwarf/NightElf/Undead/Gnome/BloodElf/Draenei.
        [(1, 22)] = 25277,
        [(2, 22)] = 25277,
        [(3, 22)] = 25277,
        [(4, 22)] = 25277,
