...
--   docker exec alexwow-mysql mysql -uroot -prootpass -e "CREATE DATABASE IF NOT EXISTS project CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci; GRANT ALL PRIVILEGES ON project.* TO 'alexwow'@'%'; FLUSH PRIVILEGES;"
